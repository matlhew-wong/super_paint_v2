...
public class DrawPanel extends JPanel {
    ...
    // ------Constructor------
    public DrawPanel(JLabel jLabel, int shapeType, 
                     Color color1, Color color2, 
                     boolean fill, boolean dash, 
                     boolean grad, int font, 
                     int dashFont) {
