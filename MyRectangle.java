...
public class MyRectangle extends MyBoundedShape {
    ...
    public MyRectangle( int x1, int x2, int y1, int y2, Color color, Color color2, boolean gradient, boolean clearCheck, int fontSize, boolean dashed, float dashSize ) {
    ...
    public void draw( Graphics2D g2d ) {
        ...
        //Draws an rectangle that isn't filled
        if ( getClearCheck() ) {
            if (getGradient()) {
